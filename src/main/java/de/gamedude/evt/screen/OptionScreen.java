...
public class OptionScreen extends Screen {
    ...
    public static final Config CONFIG = EasyVillagerTrade.CONFIG;
    ...
    public void render(DrawContext context, int mouseX, int mouseY, float delta) {
        ...
        context.drawCenteredTextWithShadow(MinecraftClient.getInstance().textRenderer, "CONFIG", (int) ((x + widgetWidth / 2F) / scale), (int) ((px + scale) / scale), -1);
